 ...
 * resizing, rotating, flipping Plus it lets you do some really cool affects.
...
public class EasyImage {
	...
	public void combineWithPicture(com.offtake.common.util.EasyImage image2) {
		combineWithPicture(image2.getAsBufferedImage(), 2, null);
	}

	public void combineWithPicture(com.offtake.common.util.EasyImage image2, int jump) {
		combineWithPicture(image2.getAsBufferedImage(), jump, null);
	}

	public void combineWithPicture(com.offtake.common.util.EasyImage image2, Color ignoreColor) {
		combineWithPicture(image2.getAsBufferedImage(), 2, ignoreColor);
	}

	public void combineWithPicture(com.offtake.common.util.EasyImage image2, int jump, Color ignoreColor) {
	...
	public static void main(String[] args) {
		/*
		 * EasyImage image = new EasyImage("c:/pics/p1.jpg"); image.resize(10);
		 * image.multiply(5, 5, 11111);
		 * image.saveAs("c:/pics/multiply+color.jpg");
		 */
		/*
		 * EasyImage image = new EasyImage("c:/pics/israel_flag.gif"); EasyImage image2 =
		 * new EasyImage("c:/pics/palestine_flag.gif"); //image.resize(50);
		 ...
		 */
		/*
		 * EasyImage image = new EasyImage("c:/pics/p1.jpg"); image.resize(50);
		 * image.affineTransform(0.0, 0.5);
		 * image.saveAs("c:/pics/affineTransform.jpg");
		 */
		/*
		 * EasyImage image = new EasyImage("c:/pics/heart.gif"); image.multiply(20, 20);
		 * EasyImage image2 = new EasyImage("c:/pics/p6.jpg"); image2.crop(800, 0, -1,
		 * -1); image2.resize(50);
...
//		image.saveAs("c:/pics/emphesizeTrick.jpg");
		...
		/*
		 * EasyImage image = new Image("c:/pics/p1.jpg");
		 * image.addColorToImage(Color.red, 5);
