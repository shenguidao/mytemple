...
import lombok.Data;
   /**
    * t_etms_boview 实体类
    * Mon Mar 02 17:17:04 CST 2020 tom
    */ 
@TableName("t_etms_boview")
@Data
public class T_etms_boviewEntity{
 	/**id*/
 	@TableField("id")
	private Integer id;
 	/**name*/
...
2：审核不通过*/
	...
	private Integer chartType;
 	/**calulate_type*/
 	@TableField("calulate_type")
	private Integer calulateType;
 	/**select_bo_id*/
 	@TableField("select_bo_id")
	private Integer selectBoId;
 	/**select_property_code*/
 	@TableField("select_property_code")
	private String selectPropertyCode;
 	/**groupby_bo_id*/
 	@TableField("groupby_bo_id")
	private Integer groupbyBoId;
 	/**groupby_property_code*/
 	@TableField("groupby_property_code")
	private String groupbyPropertyCode;
 	/**customize_action*/
 	@TableField("customize_action")
